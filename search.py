...
def search_movie(title): 
    response = reqs.get(url, params={"api_key": "fbbe539ec254190d6ae58e37abf048ea", "query": title})                # Laying out the request by inputting URL, API Key (for access to TMDB) and test search query
